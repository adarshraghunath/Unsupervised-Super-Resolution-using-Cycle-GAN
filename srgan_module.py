...
from components import SRGANDiscriminator, SRGANGenerator, VGG19FeatureExtractor
...
class SRGAN(pl.LightningModule):
    ...
    def __init__(
        ...
        if generator_checkpoint:
            ...
            m = SRResNet.load_from_checkpoint(checkpoint_path="lightning_logs/srresnet/stl10-scale_factor=4/checkpoints/epoch=49-step=3550.ckpt", image_channels =1)
            self.generator = m.srresnet
...
def cli_main(args=None):
    ...
    dm = CustomDataset(args.scale_factor, patch_size=0, batch_size=8)
    ...
    model = SRGAN(
        **vars(args), image_channels=dm.image_channels, generator_checkpoint=generator_checkpoint
