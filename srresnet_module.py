...
from components import SRGANGenerator
...
class SRResNet(pl.LightningModule):
    ...
    def __init__(
            self,
            image_channels: int = 1,  # changing image channels to 1
            feature_maps: int = 64,
...
def cli_main(args=None):
    ...
    model = SRResNet(**vars(args), image_channels=dm.image_channels)  # change to dm.dataset_train.image_channels for stl dataset
